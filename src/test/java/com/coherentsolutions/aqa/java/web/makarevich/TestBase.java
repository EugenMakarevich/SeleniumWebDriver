...
@Listeners({io.qameta.allure.testng.AllureTestNg.class, TestListener.class}) //It works this way with screenshots attached, I tried to set it up in pom file, but it does not work for me
