...
public class YandexMailLoginTest extends TestBase {
    ...
    public void testYandexMailLogin(String username, String password) throws InterruptedException {
        ...
        softAssert.assertEquals(username, driver().findElement(USER_ACCOUNT_NAME).getText(), "Username is different from expected!");
        softAssert.assertTrue(driver().getTitle().contains(YANDEX_MAIL_INBOX_TITLE),"Unexpected page title");
